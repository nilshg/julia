...
@testset "detect_ambiguities" begin
    ...
    let modules = [mod for (pkg, mod) in Base.loaded_modules if pkg.uuid !== nothing && String(pkg.name) in STDLIBS]
        ambig = detect_ambiguities(modules...; recursive=true)
        @test_broken isempty(ambig)
        ambig = Set{Any}(((m1.sig, m2.sig) for (m1, m2) in detect_ambiguities(modules...; recursive=true)))

        expect = []
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UpperTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{var"#s809",var"#s808"} where var"#s808"<:(LinearAlgebra.UpperTriangular{T,var"#s807"} where var"#s807"<:(StridedMatrix{T} where T)) where var"#s809",StridedVecOrMat{T}} where T<:Union{Float32, Float64, ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{var"#s809",var"#s808"} where var"#s808"<:(LinearAlgebra.LowerTriangular{T,var"#s807"} where var"#s807"<:(StridedMatrix{T} where T)) where var"#s809",StridedVecOrMat{T}} where T<:Union{Float32, Float64, ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{var"#s809",var"#s808"} where var"#s808"<:(LinearAlgebra.UnitLowerTriangular{T,var"#s807"} where var"#s807"<:(StridedMatrix{T} where T)) where var"#s809",StridedVecOrMat{T}} where T<:Union{Float32, Float64, ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UnitLowerTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{var"#s809",var"#s808"} where var"#s808"<:(LinearAlgebra.UnitUpperTriangular{T,var"#s807"} where var"#s807"<:(StridedMatrix{T} where T)) where var"#s809",StridedVecOrMat{T}} where T<:Union{Float32, Float64, ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Transpose{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UnitUpperTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.LowerTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{Float64,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{Float64,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{var"#s839"} where var"#s839"<:Complex}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.LowerTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{T,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{T,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{T}} where T<:Union{Float64, ComplexF64}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UpperTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{T,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{T,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{T}} where T<:Union{Float64, ComplexF64}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UnitUpperTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{T,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{T,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{T}} where T<:Union{Float64, ComplexF64}))
        push!(expect, (Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{var"#s803",var"#s802"} where var"#s802"<:(LinearAlgebra.UnitLowerTriangular{T,var"#s801"} where var"#s801"<:(StridedMatrix{T} where T)) where var"#s803",StridedVecOrMat{T}} where T<:Union{ComplexF32, ComplexF64}, Tuple{typeof(LinearAlgebra.ldiv!),LinearAlgebra.Adjoint{T,var"#s840"} where var"#s840"<:(SuiteSparse.UMFPACK.UmfpackLU{T,Ti} where Ti<:SuiteSparse.UMFPACK.UMFITypes),StridedVecOrMat{T}} where T<:Union{Float64, ComplexF64}))
